...
function App() {
    ...
    const [mode, setMode] = useState(() => {
        ...
        return path.includes('warehouse') ? 'warehouse' : 'shipping'
    })
        ...
        <div className="container">
            <header>
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                    <a href="/" className="btn-icon glass" style={{ textDecoration: 'none', fontSize: '0.8rem', padding: '0.5rem 1rem' }}>
                        ← Back to Portal
                    </a>
                </div>
                <h1>{mode === 'warehouse' ? 'Warehouse Cost System' : 'Shipping Route Cost & LT System'}</h1>
                <div className="subtitle">{mode === 'warehouse' ? 'Automatic warehouse fee calculation' : 'Smart sorting and calculation platform'}</div>
            </header>
                                    ...
                                    return (
                                        <g key={`${conn.node}-${idx}`}>
                                            ...
                                            <text
                                                ...
                                                style={{ fill: '#ffffff', fontSize: '14px', fontWeight: 900, textAnchor: 'middle' }}
                                            >
                                                {conn.node}
                                            </text>
                                        </g>
